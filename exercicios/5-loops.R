...
# [IMPORTANTE]: Você precisa instalar o pacote "beepr" antes de fazer esse exercício! 
# Isso é, você precisa executar o comando install.packages('beepr') no seu console.
