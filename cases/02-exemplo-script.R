...
# Ele é uma sequência de passos que começa com a criação de um vetor 
# de dados e depois

# 1. Calcula uma série de estatísticas desse vetor
# 2. Imprime essas estatísticas em texto para que você possa colar
# isso em outro lugar
# como um relatório, uma apresentação ou outro tipo de documento.

# Carregando os dados -----------------------------------------------------

vetor_de_dados_experimentais <-
  c(3.37, 4.32, 5.67, 8.31, 9.21, 7.89, 2.13, 4.13, 1.23, 10.11)
